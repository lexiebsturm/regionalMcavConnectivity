...
geom_rect(xmin = 0.5, xmax = 2.5, fill = "#FFA58BFF", ymin = 0.25, ymax = 0.5) +
  ...
  geom_rect(xmin = 7.5, xmax = 9.5, fill = "#C774E8FF", ymin = 0.25, ymax = 0.5) +
  geom_rect(xmin = 9.5, xmax = 11.5, fill = "#966BFFFF", ymin = 0.25, ymax = 0.5) +
  geom_rect(xmin = 11.5, xmax = 13.5, fill = "slateblue4", ymin = 0.25, ymax = 0.5) +
  #Y axis colors
  geom_rect(xmin = 13.5, xmax = 13.6, fill = "slateblue4", ymin = 12.4, ymax = 13.61) +
  geom_rect(xmin = 13.5, xmax = 13.6, fill = "#966BFFFF", ymin = 10.5, ymax = 12.39) +
  geom_rect(xmin = 13.5, xmax = 13.6, fill = "#C774E8FF", ymin = 8.5, ymax = 10.5) +
  ...
  geom_rect(xmin = 13.5, xmax = 13.6, fill = "#FF6AD5FF", ymin = 0.5, ymax = 1.5) +
...
ggsave("../figures/fig1.tiff", plot = snpHeatmap, width = 34, height = 15, units = "cm", dpi = 300)
```
...
regionalDbrdaPlot
ggsave("../figures/dbRDANoBg.png", plot = regionalDbrdaPlot, height = 5, width = 7, units = "in", dpi = 300)
```
...
# dominantClusterScatter=ggplot(k4Admix, aes(x = lon, y = lat, shape = depthZone, fill = dominantCluster)) +
#   geom_point(size = 4) +
#   scale_fill_manual(values = colPalAdmix1)+
#   scale_shape_manual(values = c(24,25), name = "Depth Zone") +
#   #labs(title = "Scatterplot of Latitude and Longitude", x = "Longitude", y = "Latitude") +
#   theme_minimal()  

# meltK4 = melt(k4Admix, id.vars=c("sample", "site", "pop", "region", "depthM", "depthZone", "dateCollected", "lat", "lon", "regionDepth"), variable.name="ancestry", value.name="fraction")
# meltK4$depthZone = factor(meltK4$depthZone, levels = levels(meltK4$depthZone)[c(2,1)])
#   
# lonScatter=ggplot(meltK4, aes(x=lon, y=fraction, fill=ancestry, shape=depthZone)) +
# geom_point() + 
...
clusterByDepth=ggplot(k4Admix, aes(x = dominantCluster, y = depthM, fill = dominantCluster)) + 
  geom_violin() +
  scale_fill_manual(values = colPalAdmix1)+
...
clusterByLat=ggplot(k4Admix, aes(x = dominantCluster, y = lat, fill = dominantCluster)) + 
  ...
  #annotate("rect", xmin = -Inf, xmax = Inf, ymin = -Inf, ymax = 23.5, fill = "gray80", alpha = 0.3)+
  labs(x = "", y = "Latitude") +
  theme_minimal()+
  theme(legend.position = "none",
        axis.text.x = element_blank(),
...
clusterByLon=ggplot(k4Admix, aes(x = lon, y = dominantCluster, fill = dominantCluster)) + 
  geom_violin() +
  ...
  scale_y_discrete(labels=c("Admixed", "Purple", "Blue", "Green", "Yellow"))+
  scale_x_continuous(labels = ~ paste0(.x, "\u00B0"))+
  #annotate("rect", xmin = -85, xmax = Inf, ymin = -Inf, ymax = Inf, fill = "gray80", alpha = 0.3)+
   #scale_y_reverse()+
...
ggsave("../figures/fig4.tiff", plot = combinedViolinPlots, width = 60, height = 20, units = "cm", dpi = 300)
...
fileList = substr(list.files("../data/ba3TraceFiles/", "BA3trace.*.txt$"),1,20)
  ...
  geom_rect(xmin=4.5, xmax=5.5, ymin=2.5, ymax=3.5, color="#C774E8FF" , fill=NA,size=2.5)+
  geom_rect(xmin=5.5, xmax=6.5, ymin=1.5, ymax=2.5, color="#966BFFFF" , fill=NA,size=2.5)+
  geom_rect(xmin=6.5, xmax=7.5, ymin=0.5, ymax=1.5, color="slateblue4" , fill=NA,size=2.5)+
  ...
  geom_rect(xmin=11.5, xmax=12.5, ymin=10.5, ymax=9.5, color="#C774E8FF" , fill=NA,size=2.5, linetype = "dotted")+
  geom_rect(xmin=12.5, xmax=13.5, ymin=8.5, ymax=9.5, color="#966BFFFF" , fill=NA,size=2.5, linetype = "dotted")+
  geom_rect(xmin=13.5, xmax=14.5, ymin=7.5, ymax=8.5, color="slateblue4" , fill=NA,size=2.5, linetype = "dotted")+  
